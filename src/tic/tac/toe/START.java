...
public class START extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Welcome.setText("WLCOME LET'S PLAY!");
        jPanel1.add(Welcome, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 480, -1, 50));

        Start.setBackground(new java.awt.Color(55, 6, 128));
        Start.setFont(new java.awt.Font("Krungthep", 2, 18)); // NOI18N
        Start.setForeground(new java.awt.Color(255, 255, 255));
        Start.setText("START!");
        Start.setActionCommand("RATE");
        Start.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                StartActionPerformed(evt);
            }
        });
        jPanel1.add(Start, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 600, 180, 50));
