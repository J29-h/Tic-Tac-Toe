 ...
 * @author ging3r
 */
public class ScoreOneVsOne extends javax.swing.JFrame {

    public ScoreOneVsOne() {
        initComponents();
    }

    public ScoreOneVsOne(String x, String i) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ScoreOneVsOne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ScoreOneVsOne().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JLabel PLAYERNAME1;
